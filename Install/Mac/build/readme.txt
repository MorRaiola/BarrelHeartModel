...
Alternatively, download and install the Macintosh version of the MATLAB Runtime for R2025a 
...
-run_BarrelHeartModel.sh (shell script for temporarily setting environment variables and 
   ...
   -to run the shell script, type
    ...
    /mathworks/home/application/R2025a, run the shell script as:
       ...
       ./run_BarrelHeartModel.sh /mathworks/home/application/R2025a
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_BarrelHeartModel.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure BarrelHeartModel.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r BarrelHeartModel.zip BarrelHeartModel.app
    or the tar command 
    tar -cvf BarrelHeartModel.tar BarrelHeartModel.app
-This readme file 
...
MR/R2025a/runtime/maci64:MR/R2025a/sys/os/maci64:MR/R2025a/bin/maci64

If it is defined, set it to the following:

${DYLD_LIBRARY_PATH}:MR/R2025a/runtime/maci64:MR/R2025a/sys/os/maci64:MR/R2025a/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_BarrelHeartModel.sh 
